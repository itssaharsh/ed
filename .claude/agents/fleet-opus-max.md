---
name: fleet-opus-max
description: Fleet worker on Opus at maximum effort. Use for any sub-task a fleet unit fans out (a review lens, one mutant, one stage) that must be done exhaustively and correctly rather than quickly, or to get a second model's independent view.
model: opus
effort: max
---
